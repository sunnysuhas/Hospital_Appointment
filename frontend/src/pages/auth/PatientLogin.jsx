...
import { LogIn, UserCircle, Lock, AlertCircle, HeartPulse } from 'lucide-react'
    ...
    <div className="flex items-center justify-center min-h-[80vh] px-4 animate-fade-in">
      <div className="w-full max-w-md card p-8 sm:p-10 relative overflow-hidden group">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-secondary-900 tracking-tight">Patient Portal</h2>
          <p className="text-secondary-500 mt-2 text-sm">Log in to book and manage appointments.</p>
        </div>
        ...
        <p className="text-center mt-6 text-secondary-500 text-sm">
          Don't have an account? <Link to="/patient/register" className="text-primary-600 font-semibold hover:text-primary-700 transition-colors">Register here</Link>
        </p>
      </div>
    </div>
  )
