...
import { LogIn, UserCircle, Lock, AlertCircle, Stethoscope } from 'lucide-react'
    ...
    <div className="flex items-center justify-center min-h-[80vh] px-4 animate-fade-in">
      <div className="w-full max-w-md card p-8 sm:p-10 relative overflow-hidden group">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-secondary-900 tracking-tight">Doctor Portal</h2>
          <p className="text-secondary-500 mt-2 text-sm">Access your schedule and appointments.</p>
        </div>
